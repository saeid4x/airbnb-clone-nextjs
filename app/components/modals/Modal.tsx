...
const handleSecondaryActionLabel = () =>{}
    return ( 
        <>
            <div className='justify-center items-center flex overflow-x-hidden 
                            ...
                            {/* 
                                ** bg-neutral-800/70 === reduce opacity background by 70%
                                ** overflow-x: hidden === not show scrolbar 
                                ** overflow-x:auto === Overflow content is clipped at the element's padding box, and overflow 
                                    content can be scrolled into view. Unlike scroll , user agents display scroll bars only if
                                    the content is overflowing and hide scroll bars by default
                                ** inset: Set the distance to the parent element from the positioned <div> element
                            */}
                            ...
                            <div className='translate h-full lg:h-auto md:h-auto border-0 rounded-lg shadow-lg relative flex flex-col w-full bg-white outline-none focus:outline-none'>
                                ...
                                <div className='flex flex-col gap-2 p-6'>
                                    <div className='flex flex-row items-center gap-4 w-full'>
                                        ...
                                        {/* label={actionLabel} in <Button> === <Modal actionLabel = 'something'>  */}
